                    ...
                    <div className="container">
                        <div className="single">
                            ...
                            <div className="single__bot">
                                ...
                                <div className="single__bot__reviewers">
                                    <div className="single__bot__reviewer">
                                        ...
                                        <div className="single__bot__reviewer__info">
                                            ...
                                            <p>
                                                I bought it 3 weeks ago and now
                                                come back just to say “Awesome
                                                Product”. I really enjoy it. At
                                                vero eos et accusamus et iusto
                                                odio dignissimos ducimus qui
                                                blanditiis praesentium
                                                voluptatum deleniti atque
                                                corrupt et quas molestias
                                                excepturi sint non provident.
                                            </p>
                                ...
                                <button className="single__bot__load">
                                    Load more
                                </button>
                            </div>
                        </div>
